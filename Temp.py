...
sql = "SELECT dn, userlabel, pdcpupoctul, pdcpupoctdl FROM pm_eutrancelltdd_day WHERE datetime = '2018-07-26 00:00:00'"
cursor.execute(sql)
title = [i[0] for i in cursor.description]
data = cursor.fetchall()
df = pd.DataFrame(data, columns = title)
df.to_csv('pm_eutrancelltdd_day_0726.csv', index=True, header=True, encoding='gbk')
#print (data)
cursor.close()
conn.close()
